...
class clsString
{
    ...
    string ReplaceWordInString(string StringToReplace,string sRepalceTo)
    {
        return ReplaceWordInString(_value,StringToReplace,sRepalceTo);
    }
    ...
    vector<string> SplitString(string delm = " ")
    {
        return SplitString(_value,delm);
    }
};
*/